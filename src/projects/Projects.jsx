const projects = [
  {
    ...
    description:
      "An activity-tracking web app built with React and Tailwind CSS, designed to help users monitor daily activities, visualize habits, and manage personal goals.",
  ...
  },
  {
    ...
    name: "Easy Exams",
    description:
      "A user-focused CBT interface designed in Figma, featuring intuitive question layouts, answer selection, navigation, and exam controls for a smooth testing experience.",
  ...
  },
  {
    ...
    name: "Ace Jobs",
    description:
      "A job application platform built with HTML, CSS, and JavaScript, featuring job discovery, role selection, a guided application process, and a review step before submission.",
  ...
  },
  {
    ...
    name: "Weather App",
    description:
      "A weather application that integrates a live weather API to let users search locations and view current conditions, temperature, humidity, wind speed, and other weather details.",
    technologies: ["HTML", "CSS", "JavaScript"],
  ...
  },
  {
    ...
    name: "Lounge",
    description:
      "A modern e-commerce clothing concept designed in Figma, combining clean product layouts, intuitive navigation, and simple wireframes to create a streamlined shopping experience.",
    technologies: ["Figma", "UI/UX"],
  ...
  },
  {
    ...
    description:
      "A React-based movie discovery platform that uses an external API to display trending movies and shows, with detailed information and trailer previews.",
